...
blogs_schema = {
    ...
    "posts_order_sequence": {"type": "float", "default": 0.00},
    "blog_status": {
        "type": "string",
    ...
    "members": {
        "type": "list",
        "schema": {"type": "dict", "schema": {"user": Resource.rel("users", True)}},
        "maxmembers": True,
    },
    "blog_preferences": {
        "type": "dict",
    ...
    "theme_settings": {"type": "dict", "mapping": {"type": "object", "enabled": False}},
    "public_url": {"type": "string"},
    "public_urls": {"type": "dict", "mapping": {"type": "object", "enabled": False}},
    "syndication_enabled": {"type": "boolean", "default": False},
    ...
    "blog_author": {"type": "string", "default": ""},
    "delete_not_before": {
        "type": "datetime",
        "default": None,
        "nullable": True,
    ...
    "posts_limit": {"type": "integer", "nullable": True, "default": 500},
    "users_can_comment": {
        "type": "string",
