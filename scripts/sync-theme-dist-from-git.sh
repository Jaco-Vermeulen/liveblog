...
THEME_FILES=(
  ...
  server/liveblog/themes/themes_assets/tribute-ultimate/dist/tribute-ultimate.css
  server/liveblog/themes/themes_assets/tribute-ultimate/theme.json
  server/liveblog/themes/themes_assets/tribute-ultimate/templates
  server/liveblog/themes/themes_assets/tribute-ultimate/template.html
  server/liveblog/system_themes.py
...
echo -n "[sync-theme-dist] tribute-ultimate.css scorecard rules: "
grep -c lb-scorecard-card server/liveblog/themes/themes_assets/tribute-ultimate/dist/tribute-ultimate.css

curl -sf "http://127.0.0.1:5000/api/theme-redeploy/tribute-ultimate" >/dev/null || true
curl -sf "http://127.0.0.1:5000/api/theme-redeploy/default" >/dev/null || true

echo -n "[sync-theme-dist] HTTP scorecard rules: "
curl -s "http://127.0.0.1:5000/themes_assets/tribute-ultimate/dist/tribute-ultimate.css" | grep -c lb-scorecard-card || true
